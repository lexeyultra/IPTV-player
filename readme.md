...
**Сервер**: http://31.204.185.12:9393
...
### Контент
- Встроенный плейлист **IPTV Russia** (~300 каналов) из [iptv-org](https://iptv-org.github.io/iptv/countries/ru.m3u)
- Каналы: Первый, НТВ, СТС, ТНТ, РенТВ, Россия 1, Евронews, MTV и др.
- Автоматическая категоризация по group-title и ключевым словам
- Умное назначение логотипов по названию канала
